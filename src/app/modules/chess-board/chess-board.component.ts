...
import { CheckState, Color, Coordinates, FENChar, LastMove, SafeSquares, pieceImagePaths } from '../../chess-logic/models';
...
export class ChessBoardComponent {
  ...
  private promotionCoords: Coordinates | null = null;
  ...
  private unmarkingPreviousSelectedSafeSquares(): void {
  ...
  public selectingPiece(x: number, y: number): void{
    ...
    this.unmarkingPreviousSelectedSafeSquares();
